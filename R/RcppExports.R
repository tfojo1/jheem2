...
do_matrix_multiply_A_specified_interpolated_blocks_increment <- function(*A, *B, *dst, m_A, m_B, n_B, n_blocks, *A_block_per_row) {
    invisible(.Call(`_jheem2_do_matrix_multiply_A_specified_interpolated_blocks_increment`, *A, *B, *dst, m_A, m_B, n_B, n_blocks, *A_block_per_row))
}

do_matrix_multiply_A_specified_interpolated_blocks_increment <- function(*A, *B, *dst, *A_blocks_per_row, m_A, m_B, n_B, n_blocks) {
    invisible(.Call(`_jheem2_do_matrix_multiply_A_specified_interpolated_blocks_increment`, *A, *B, *dst, *A_blocks_per_row, m_A, m_B, n_B, n_blocks))
}
